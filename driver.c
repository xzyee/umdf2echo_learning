...
NTSTATUS
DriverEntry(
    IN PDRIVER_OBJECT  DriverObject, //还是传统的样子
    IN PUNICODE_STRING RegistryPath  //还是传统的样子
    )
/*++
...
--*/
{
    ...
    WDF_DRIVER_CONFIG_INIT(&config,
                            EchoEvtDeviceAdd //此回调函数装到config里面
                           );
